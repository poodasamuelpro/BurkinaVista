 ...
 * Layout Option C : dropzone vidéo sous dropzone image (colonne gauche uniquement)
 */
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ══════════════════════════════════════════════════
            ...
            Colonne gauche : images + vidéo (bloquée) empilées
            Colonne droite : formulaire sur toute la hauteur
        ══════════════════════════════════════════════════ */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* ══════════════════════════════════════════════════
                SECTION VIDÉO — collée sous, colonne gauche uniquement
            ══════════════════════════════════════════════════ */}
            <div className={`border-t ${sectionDivider} pt-6`}>
              ...
              <div className="relative rounded-3xl overflow-hidden">
                ...
                {/* Fausse dropzone vidéo + note (désactivé, juste visuel) */}
          ...
          <div className="space-y-5">
            ...
            {/* Spacer pour aligner avec le début du formulaire (après le titre section) */}
